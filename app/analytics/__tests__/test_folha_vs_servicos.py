...
import db
from app.analytics.folha_vs_servicos import run
...
def test_execucao_decimo_terceiro(conn):
    from app.analytics.folha_vs_servicos import execucao_decimo_terceiro
...
def test_detalhe_decimo_terceiro(conn):
    from app.analytics.folha_vs_servicos import detalhe_decimo_terceiro
